...
if($deviceVersion <> $versionavailable)
{
	...
	/*
	$queryAsuransi  = "select * from ajkinsurance where id = '$asuransi'";
	$resultAsuransi = query_db($queryAsuransi);
	$encodedAsuransi= mysql_fetch_assoc($resultAsuransi);
	$idAsuransi     = $encodedAsuransi['id'];
    */
	...
	$cek_query 		= "SELECT * FROM ajkspk WHERE nama = '$nama' AND dob = '$dob' AND plafond = '$plafond' and del is null";
