...
if($usersType == "Direksi"){
	...
	$querySelect2 = "SELECT regional,
					...
					FROM (
						SELECT
						COUNT(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.nama END) AS daily_peserta,
						COUNT(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.nama END) AS monthly_peserta,
						COUNT(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.nama END) AS yearly_peserta,
						SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd'  THEN ajkpeserta.plafond END) AS daily_kredit,
						SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.plafond END) AS monthly_kredit,
						SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.plafond END) AS yearly_kredit,
						SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart'  AND '$dateEnd'  THEN ajkpeserta.totalpremi END) AS daily_premi,
						SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart'  AND '$dateEnd' THEN ajkpeserta.totalpremi END) AS monthly_premi,
						SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart'  AND '$dateEnd' THEN ajkpeserta.totalpremi END) AS yearly_premi,
						...
						WHERE ajkpeserta.id !=''
						$filterquery
						AND ajkpeserta.statusaktif in ('Inforce','Approve')
						AND ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd'
						$filterquery2
