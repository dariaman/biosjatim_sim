...
if($nmgrup == 'All Report'){
    ...
    SELECT
			...
			COUNT(CASE WHEN ajkpeserta.tglakad BETWEEN '$startMonth' AND LAST_DAY('$dateEnd') THEN ajkpeserta.nama END) AS monthly_peserta,
			COUNT(CASE WHEN ajkpeserta.tglakad BETWEEN '$startYear'  AND '$endYear' THEN ajkpeserta.nama END) AS yearly_peserta,
			SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.plafond END) AS daily_kredit,
			SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$startMonth' AND LAST_DAY('$dateEnd') THEN ajkpeserta.plafond END) AS monthly_kredit,
			SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$startYear'  AND '$endYear' THEN ajkpeserta.plafond END) AS yearly_kredit,
			SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$dateStart' AND '$dateEnd' THEN ajkpeserta.totalpremi END) AS daily_premi,
			SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$startMonth' AND LAST_DAY('$dateEnd') THEN ajkpeserta.totalpremi END) AS monthly_premi,
			SUM(CASE WHEN ajkpeserta.tglakad BETWEEN '$startYear'  AND '$endYear' THEN ajkpeserta.totalpremi END) AS yearly_premi,
