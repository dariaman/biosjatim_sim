...
out('site_title', 'Backend - Credit Life Insurance online System');
...
if (isset($_SESSION['username'])) {	$q=mysql_fetch_array($database->doQuery('SELECT * FROM useraccess WHERE username="'.$_SESSION['username'].'"'));}
if ($q['idbroker']==NULL) {
	$q_ = '';
	$q__ = '';
	$q___ = '';
