  ...
  case "edit":
    ...
    if($_REQUEST['btnedit']=="procedit"){
      ...
      $newketerangan = $_REQUEST['keterangan'];
		...
		//echo $bukti_gambar; exit;
	  
      $queryold = "INSERT INTO ajkhispeserta 
                SET idpeserta='".$qpes['idpeserta']."',his='OLD',asuransi='".$qpes['asuransi']."',pekerjaan='".$qpes['pekerjaan']."',rate='".$qpes['premirate']."',premi='".$qpes['premi']."',keterangan='".$qpes['keterangan']."',input_by = '".$q['username']."',input_date=now();";
      $querynew = "INSERT INTO ajkhispeserta 
                SET idpeserta='".$qpes['idpeserta']."',his='NEW',asuransi='$newas',pekerjaan='$newprofesi',rate='$newrate',premi='$newpremi',keterangan='$newketerangan',input_by='".$q['username']."',input_date=now();";
