...
{		// To be implemented in your own inherited class
	if ($_REQUEST['er']=="_kwitansi")
	{
		...
		$this->SetFont('Arial','B',10);									  	// setting properti font
		//$this->Cell(190,0,'PT Adonai Pialang Asuransi',0,0,'R');
	}elseif ($_REQUEST['er']=="eR_peserta"){
		$this->SetFont('Arial','I',10);										// setting properti font
		$this->Cell(150,-10,'Laporan Data Kepesertaan',0,0,'L');
		$this->Cell(50);	 													// membuat jarak terhadap cell sebelumnya
		$this->SetFont('Arial','B',10);
		$this->Cell(135,-10,'www.ajk.adonai.co.id',0,0,'R');
		$this->Line(11,8,345,8);
		$this->Ln(5);
	}elseif ($_REQUEST['er']=="eR_DN"){
		$this->SetFont('Arial','I',10);										// setting properti font
		$this->Cell(70,-10,'Laporan Data Debitnote',0,0,'L');
		$this->Cell(120);	 													// membuat jarak terhadap cell sebelumnya
		$this->SetFont('Arial','B',10);
		$this->Cell(75,-10,'www.ajk.adonai.co.id',0,0,'R');
		$this->Line(11,8,275,8);
		$this->Ln(5);
	}elseif ($_REQUEST['er']=="eR_CN"){
		$this->SetFont('Arial','I',10);										// setting properti font
		$this->Cell(150,-10,'Laporan Data Credit Note',0,0,'L');
		$this->Cell(50);	 													// membuat jarak terhadap cell sebelumnya
		$this->SetFont('Arial','B',10);
		$this->Cell(75,-10,'www.ajk.adonai.co.id',0,0,'R');
		$this->Line(11,8,287,8);
		$this->Ln(5);
	}
	else{
		$this->SetFont('Arial','I',10);										// setting properti font
		//$this->Cell(265,10,'Aplikasi AJK ONLINE',0,0,'R');			// menulis header
		//$this->Cell(0);	 													// membuat jarak terhadap cell sebelumnya
		$this->Ln(0);
		$this->SetFont('Arial','B',10);									  	// setting properti font
		//$this->Cell(270,0,'PT Adonai Pialang Asuransi',0,0,'R');
		//$this->Line(11,13,198,13);											// membuat garis dari koordinat (11 mm, 18 mm) sampai koordinat (198 mm,18 mm)
		$this->Ln(10);
	}
}
